...
class PropertyType(Enum):
    ...
    Each type has a unique numeric value for visualisation.
    """
...
class Property:
    ...
    Attributes:
        ...
        has_nectar (bool): Whether the property contains nectar (FLOWER = True, Others = False)
    """
...
class World:
    ...
    Attributes:
        properties (list): List of Property in the world
